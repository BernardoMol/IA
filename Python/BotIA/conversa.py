...
def categorizar_produtos(mensagem, categorias):
    prompt_sistema = f"""
    ...
    resposta = llm.generate_content(mensagem)
...
def main():
    ...
    # Comando e resposta
    pergunta = input("Informe os alimentos para classificar: ")
    while pergunta != "":
        print(
            f"Resposta: \n{categorizar_produtos(pergunta, lista_de_categorias)}"
        )
        pergunta = input("Informe o produto que você deseja classificar: ")

    print(f"RESPOSTA FINAL: OBRIGADO PELA CONVERSA")
